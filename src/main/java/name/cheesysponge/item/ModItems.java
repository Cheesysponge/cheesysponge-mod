...
public class ModItems {
    ...
    public static final Item CHEESY_SPONGE_HOE = registerItem("cheesy_sponge_hoe", new ModHoeItem(ModToolMaterials.CHEESYSPONGE,3,20f,new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.CHEESY_SPONGE).maxCount(1)));
    public static final Item CHEESY_SPONGE_SHOVEL = registerItem("cheesy_sponge_shovel", new ShovelItem(ModToolMaterials.CHEESYSPONGE,14,-3.5f,new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.CHEESY_SPONGE).maxCount(1)));
    ...
    public static final Item CHEESY_SPONGE_BOOTS = registerItem("cheesy_sponge_boots", new ModArmorItem(ModArmorMaterials.CHEESY_SPONGE, EquipmentSlot.FEET,new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.CHEESY_SPONGE).maxCount(1)));public static final Item DATA_TABLET = registerItem("data_tablet", new DataTabletItem(new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.CHEESY_SPONGE).maxCount(1)));
    public static final Item SPONGE_HELMET = registerItem("sponge_helmet", new ModArmorItem(ModArmorMaterials.SPONGE, EquipmentSlot.HEAD,new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.CHEESY_SPONGE).maxCount(1)));
    public static final Item SPONGE_CHESTPLATE = registerItem("sponge_chestplate", new ModArmorItem(ModArmorMaterials.SPONGE, EquipmentSlot.CHEST,new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.CHEESY_SPONGE).maxCount(1)));
    public static final Item SPONGE_LEGGINGS = registerItem("sponge_leggings", new ModArmorItem(ModArmorMaterials.SPONGE, EquipmentSlot.LEGS,new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.CHEESY_SPONGE).maxCount(1)));
    public static final Item SPONGE_BOOTS = registerItem("sponge_boots", new ModArmorItem(ModArmorMaterials.SPONGE, EquipmentSlot.FEET,new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.CHEESY_SPONGE).maxCount(1)));
    public static final Item CHEESE_HELMET = registerItem("cheese_helmet", new ModArmorItem(ModArmorMaterials.CHEESE, EquipmentSlot.HEAD,new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.CHEESY_SPONGE).maxCount(1)));
    public static final Item CHEESE_CHESTPLATE = registerItem("cheese_chestplate", new ModArmorItem(ModArmorMaterials.CHEESE, EquipmentSlot.CHEST,new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.CHEESY_SPONGE).maxCount(1)));
    public static final Item CHEESE_LEGGINGS = registerItem("cheese_leggings", new ModArmorItem(ModArmorMaterials.CHEESE, EquipmentSlot.LEGS,new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.CHEESY_SPONGE).maxCount(1)));
    public static final Item CHEESE_BOOTS = registerItem("cheese_boots", new ModArmorItem(ModArmorMaterials.CHEESE, EquipmentSlot.FEET,new FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().group(ModItemGroup.CHEESY_SPONGE).maxCount(1)));
    ...
    public static final Item HYPE_MUSIC_DISC = registerItem("hype_music_disc", new ModMusicDiscItem(7, ModSounds.HYPE_MUSIC,new  FabricItemSettings().rarity(Rarity.UNCOMMON).fireproof().maxDamage(1000).group(ModItemGroup.CHEESY_SPONGE),147));
