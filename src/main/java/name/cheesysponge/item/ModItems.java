...
public class ModItems {
    public static final Item PURE_CHEESE = registerItem("pure_cheese", new Item(new FabricItemSettings().food(ModFoodComponents.PURE_CHEESE).rarity(Rarity.UNCOMMON).fireproof().maxCount(12)));
