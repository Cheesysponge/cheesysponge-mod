...
public class CheeseRenderer extends DynamicGeoEntityRenderer<CheeseEntity> {
...
//    }
@Override
public void preRender(MatrixStack poseStack, CheeseEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
